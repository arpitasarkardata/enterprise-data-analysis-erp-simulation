...
This project follows the complete data analytics workflow — from raw CSV ingestion to business insight generation — simulating how an ERP system would process and report on transactional data across Sales, Customer, Product, and Logistics modules.
...
│
├── csv_to_mysql.ipynb          ← Automated CSV to MySQL ingestion pipeline
...
**e-Commerce (Target) Sales Dataset** — 100,000+ real e-commerce orders
...
4. Seller performance and ranking
5. Payment method distribution
6. Order status breakdown and delivery analysis
...
```
Open csv_to_mysql.ipynb in Jupyter
...
```
Open ecommerce_sql_python.ipynb in Jupyter
Kernel → Restart & Run All
```
...
This project was built following the WsCube Tech Data Analytics Portfolio Project guide.
